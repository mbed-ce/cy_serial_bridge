...
class Enum:
    ...
    def __init__(self, member_dict: Dict[str, int], scope_dict: Dict[str, Any] = ...) -> None: ...
    def __call__(self, value: int) -> str: ...
    def get(self, value: int, default: Optional[str] = ...) -> str: ...

def buffer_at(address: c_int, length: c_int) -> bytearray: ...
...
libusb_descriptor_alias = Union[
    libusb_config_descriptor_p_alias, libusb_endpoint_descriptor_p_alias, libusb_interface_descriptor_p_alias
]
...
def libusb_set_debug(ctx: libusb_context_p_alias, level: c_int) -> None: ...
...
def libusb_get_device_list(ctx: libusb_context_p_alias, list: libusb_device_p_p_p_alias) -> c_ssize_t: ...
def libusb_free_device_list(list: libusb_device_p_p_alias, unref_devices: c_int) -> None: ...
...
def libusb_get_configuration(dev: libusb_device_handle_p_alias, config: pointer[c_int]) -> c_int: ...
def libusb_get_device_descriptor(dev: libusb_device_p_alias, desc: libusb_device_descriptor_p_alias) -> c_int: ...
def libusb_get_active_config_descriptor(
    dev: libusb_device_p_alias, config: libusb_config_descriptor_p_alias
) -> c_int: ...
def libusb_get_config_descriptor(
    dev: libusb_device_p_alias, config_index: c_uint8, config: libusb_config_descriptor_p_p_alias
) -> None: ...
def libusb_get_config_descriptor_by_value(
    dev: libusb_device_p_alias, bConfigurationValue: c_uint8, config: libusb_config_descriptor_p_p_alias
) -> c_int: ...
...
def libusb_get_port_numbers(
    dev: libusb_device_p_alias, port_numbers: pointer[c_uint8], port_numbers_len: c_int
) -> c_int: ...
...
def libusb_get_max_packet_size(dev: libusb_device_p_alias, endpoint: c_uint8) -> c_int: ...
def libusb_get_max_iso_packet_size(dev: libusb_device_p_alias, endpoint: c_uint8) -> c_int: ...
def libusb_open(dev: libusb_device_p_alias, handle: libusb_device_handle_p_p_alias) -> c_int: ...
...
def libusb_set_configuration(dev: libusb_device_handle_p_alias, configuration: c_int) -> c_int: ...
def libusb_claim_interface(dev: libusb_device_handle_p_alias, iface: c_int) -> c_int: ...
def libusb_release_interface(dev: libusb_device_handle_p_alias, iface: c_int) -> c_int: ...
def libusb_open_device_with_vid_pid(
    ctx: libusb_context_p_alias, vendor_id: c_uint16, product_id: c_uint16
) -> libusb_device_handle_p_alias: ...
def libusb_set_interface_alt_setting(
    dev: libusb_device_handle_p_alias, interface_number: c_int, alternate_setting: c_int
) -> c_int: ...
def libusb_clear_halt(dev: libusb_device_handle_p_alias, endpoint: c_uchar) -> c_int: ...
def libusb_reset_device(dev: libusb_device_handle_p_alias) -> c_int: ...
def libusb_kernel_driver_active(dev: libusb_device_handle_p_alias, interface: c_int) -> c_int: ...
def libusb_detach_kernel_driver(dev: libusb_device_handle_p_alias, interface: c_int) -> c_int: ...
def libusb_attach_kernel_driver(dev: libusb_device_handle_p_alias, interface: c_int) -> c_int: ...
def libusb_set_auto_detach_kernel_driver(dev: libusb_device_handle_p_alias, enable: c_int) -> c_int: ...
...
def libusb_fill_control_setup(
    setup_p: str, bmRequestType: c_uint8, bRequest: c_uint8, wValue: c_uint16, wIndex: c_uint16, wLength: c_uint16
) -> None: ...
...
def libusb_fill_control_transfer(
    transfer_p: libusb_transfer_p_alias,
...
def libusb_set_iso_packet_lengths(transfer_p: libusb_transfer_p_alias, length: c_int) -> None: ...
def libusb_get_iso_packet_buffer(transfer_p: libusb_transfer_p_alias, packet: c_int) -> bytearray: ...
def libusb_get_iso_packet_buffer_simple(transfer_p: libusb_transfer_p_alias, packet: c_int) -> bytearray: ...
def libusb_control_transfer(
    dev_handle: libusb_device_handle_p_alias,
...
def libusb_get_descriptor(
    dev: libusb_device_handle_p_alias, desc_type: c_uint16, desc_index: c_uint16, data: c_void_p, length: c_uint16
) -> c_int: ...
def libusb_get_string_descriptor(
    dev: libusb_device_handle_p_alias, desc_index: c_uint16, langid: c_uint16, data: c_void_p, length: c_uint16
) -> c_int: ...
def libusb_get_string_descriptor_ascii(
    dev: libusb_device_handle_p_alias, index: c_uint8, data: c_void_p, length: c_int
) -> c_int: ...
...
def libusb_wait_for_event(ctx: libusb_context_p_alias, tv: timeval_p_alias) -> c_int: ...
def libusb_handle_events_timeout(ctx: libusb_context_p_alias, tv: timeval_p_alias) -> c_int: ...
def libusb_handle_events_timeout_completed(
    ctx: libusb_context_p_alias, tv: timeval_p_alias, completed: c_int_p_alias
) -> c_int: ...
def libusb_handle_events(ctx: libusb_context_p_alias) -> c_int: ...
def libusb_handle_events_completed(ctx: libusb_context_p_alias, completed: c_int_p_alias) -> c_int: ...
def libusb_handle_events_locked(ctx: libusb_context_p_alias, tv: timeval_p_alias) -> c_int: ...
def libusb_get_next_timeout(ctx: libusb_context_p_alias, tv: timeval_p_alias) -> c_int: ...
def libusb_get_pollfds(ctx: libusb_context_p_alias) -> libusb_pollfd_p_p_alias: ...
def libusb_set_pollfd_notifiers(
    ctx: libusb_context_p_alias,
    added_cb: libusb_pollfd_added_cb_p_alias,
    removed_cb: libusb_pollfd_removed_cb_p_alias,
    user_data: c_void_p,
) -> None: ...
def libusb_hotplug_register_callback(
    ctx: libusb_context_p_alias,
    events: int,
    flag: int,
    vendor_id: int,
    ...
    user_data: c_void_p,
    handle: libusb_hotplug_callback_handle_p_alias,
) -> c_int: ...
def libusb_hotplug_deregister_callback(
    ctx: libusb_context_p_alias, handle: libusb_hotplug_callback_handle_alias
) -> None: ...
