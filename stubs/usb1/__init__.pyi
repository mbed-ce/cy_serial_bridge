...
from . import libusb1  # type: ignore[attr-defined]
...
if sys.version_info < (3, 12):
    Buffer: TypeAlias = collections.abc.ByteString  # noqa: PYI057
else:
    Buffer: TypeAlias = Union[bytes, bytearray, memoryview]
BufferList: TypeAlias = list[Buffer]
BufferOrLength: TypeAlias = Union[Buffer, int]
Endpoint = int
UserData = object
Timeout = int
PollTimeout: TypeAlias = Union[float, int, None]
TransferType = int
TransferStatus = int
TransferCallback: TypeAlias = Callable[[USBTransfer], None]
ErrorCallback: TypeAlias = Callable[[int], None]
FileDescriptor = int
Events: TypeAlias = Any
FDNotifierCallback: TypeAlias = Callable[[int, int, Any], None]
RegisterCallback: TypeAlias = Callable[[USBContext, USBDevice, int], None]
...
class USBTransfer:
    def __init__(
        ...
        after_completion: TransferCallback,
    ) -> None: ...
    def close(self) -> None: ...
    def doom(self) -> None: ...
    ...
    def setIsochronous(
        ...
        user_data: Optional[UserData] = ...,
        timeout: Timeout = ...,
        iso_transfer_length_list: Optional[list[int]] = ...,
    ) -> None: ...
    ...
    def setBuffer(self, buffer_or_len: BufferOrLength) -> None: ...
    def isSubmitted(self) -> bool: ...
    def submit(self) -> None: ...
    def cancel(self) -> None: ...

class USBTransferHelper:
    def __init__(self, transfer: Optional[USBTransfer] = ...) -> None: ...
    def submit(self) -> None: ...
    def cancel(self) -> None: ...
    def setEventCallback(self, event: int, callback: TransferCallback) -> None: ...
    def setDefaultCallback(self, callback: TransferCallback) -> None: ...
    def getEventCallback(self, event: int, default: Optional[TransferCallback] = ...) -> Optional[TransferCallback]: ...
    def __call__(self, transfer: USBTransfer) -> None: ...
    def isSubmited(self) -> bool: ...

class USBPollerThread(threading.Thread):
    daemon: bool = ...

    def __init__(self, context: USBContext, poller: USBPoller, exc_callback: Optional[ErrorCallback] = ...) -> None: ...
    def stop(self) -> None: ...
    @staticmethod
...
class USBPoller:
    def __init__(self, context: USBContext, poller: USBPoller) -> None: ...
    def __del__(self) -> None: ...
    def poll(self, timeout: PollTimeout = ...) -> list[tuple[int, int]]: ...
    def register(self, fd: FileDescriptor, events: Events) -> None: ...
    def unregister(self, fd: FileDescriptor) -> None: ...

class _ReleaseInterface:
    def __init__(self, handle: USBDeviceHandle, interface: int) -> None: ...
...
class USBDeviceHandle:
    def __init__(
        self, context: USBContext, handle: libusb1.libusb_device_handle_p_alias, device: USBDevice
    ) -> None: ...
    def __del__(self) -> None: ...
    def close(self) -> None: ...
    def getDevice(self) -> USBDevice: ...
    def getConfiguration(self) -> int: ...
    def setConfiguration(self, configuration: int) -> None: ...
    def getManufacturer(self) -> str: ...
    def getProduct(self) -> str: ...
    def getSerialNumber(self) -> str: ...
    def claimInterface(self, interface: int) -> _ReleaseInterface: ...
    def releaseInterface(self, interface: int) -> None: ...
    def setInterfaceAltSetting(self, interface: int, alt_setting: int) -> None: ...
    def clearHalt(self, endpoint: int) -> None: ...
    def resetDevice(self) -> None: ...
    def kernelDriverActive(self, interface: int) -> bool: ...
    def detachKernelDriver(self, interface: int) -> None: ...
    def attachKernelDriver(self, interface: int) -> None: ...
    def setAutoDetachKernelDriver(self, enable: bool) -> None: ...
    def getSupportedLanguageList(self) -> list[int]: ...
    def getStringDescriptor(self, descriptor: int, lang_id: int, errors: str = ...) -> str: ...
    def getASCIIStringDescriptor(self, descriptor: int, errors: str = ...) -> str: ...
    def controlWrite(
        self, request_type: int, request: int, value: int, index: int, data: Buffer, timeout: int = ...
    ) -> int: ...
    def controlRead(
        self, request_type: int, request: int, value: int, index: int, length: int, timeout: int = ...
    ) -> bytes: ...
    def bulkWrite(self, endpoint: int, data: Buffer, timeout: int = ...) -> int: ...
    def bulkRead(self, endpoint: int, length: int, timeout: int = ...) -> bytearray: ...
    def interruptWrite(self, endpoint: int, data: Buffer, timeout: int = ...) -> int: ...
    def interruptRead(self, endpoint: int, length: int, timeout: int = ...) -> bytes: ...
    def getTransfer(self, iso_packets: int = ...) -> USBTransfer: ...

class USBConfiguration:
    def __init__(self, context: USBContext, config: libusb1.libusb_config_descriptor, device_speed: int) -> None: ...
    def __iter__(self) -> Iterator[USBInterface]: ...
    def __getitem__(self, interface: int) -> USBInterface: ...
...
class USBInterface:
    def __init__(self, context: USBContext, interface: int) -> None: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> Iterator[USBInterfaceSetting]: ...
    def __getitem__(self, alt_setting: int) -> USBInterfaceSetting: ...
    def getNumSettings(self) -> int: ...
    def iterSettings(self) -> Iterator[USBInterfaceSetting]: ...

class USBInterfaceSetting:
    def __init__(self, context: USBContext, alt_setting: libusb1.libusb_interface_descriptor_p_alias) -> None: ...
    def __iter__(self) -> Iterator[USBEndpoint]: ...
    def __len__(self) -> int: ...
    def __getitem__(self, endpoint: int) -> USBEndpoint: ...
...
class USBEndpoint:
    def __init__(self, context: USBContext, endpoint: libusb1.libusb_endpoint_descriptor_p_alias) -> None: ...
...
class USBDevice:
    ...
    def __init__(
        self, context: USBContext, device_p: libusb1.libusb_device_p_alias, can_load_configuration: bool = ...
    ) -> None: ...
    def __del__(self) -> None: ...
    def __len__(self) -> int: ...
    def __getitem__(self, index: int) -> USBConfiguration: ...
    ...
    def getMaxPacketSize(self, endpoint: int) -> int: ...
    def getMaxISOPacketSize(self, endpoint: int) -> int: ...
...
class USBContext:
    ...
    def close(self) -> None: ...
    def exit(self) -> None: ...
    def getDeviceIterator(self, skip_on_error: bool = ...) -> Iterator[USBDevice]: ...
    def getDeviceList(self, skip_on_access_error: bool = ..., skip_on_error: bool = ...) -> list[USBDevice]: ...
    def getByVendorIDAndProductID(
        self, vendor_id: Any, product_id: Any, skip_on_access_error: bool = ..., skip_on_error: bool = ...
    ) -> Optional[USBDevice]: ...
    def openByVendorIDAndProductID(
        self, vendor_id: Any, product_id: Any, skip_on_access_error: bool = ..., skip_on_error: bool = ...
    ) -> Optional[USBDeviceHandle]: ...
    def getPollFDList(self) -> tuple[int, int]: ...
    def handleEvents(self) -> None: ...
    def handleEventsTimeout(self, tv: int = ...) -> None: ...
    ...
    def waitForEvent(self, tv: int = ...) -> None: ...
    ...
    def hotplugDeregisterCallback(self, handle: int) -> None: ...
